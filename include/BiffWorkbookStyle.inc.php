...
class BiffWorkbookStyle extends BiffWorkbookElement implements IBiffWorkbookCss
{
	...
	public function build ()
	{
		...
		if ($this->_workbook->biffVersion == 5)
		{
			...
			$raws ['left'][1]		= $raws ['left'][0] == 0 ? null : ($this->raw ['border_bg2'] >> 16) & 0x07;
			$raws ['right'][1]		= $raws ['right'][0] == 0 ? null : ($this->raw ['border_bg2'] >> 23) & 0x07;
			$raws ['top'][1]		= $raws ['top'][0] == 0 ? null : ($this->raw ['border_bg2'] >> 9) & 0x07;
			$raws ['bottom'][1]		= $raws ['bottom'][0] == 0 ? null : ($this->raw ['border_bg1'] >> 25) & 0x07;
			...
			$this->backgroundColor = $this->pattern == 0
				? $this->_workbook->palette [($this->raw ['border_bg1'] >> 7) & 0x07]
				: $this->_workbook->palette [$this->raw ['border_bg1'] & 0x07];
		}
		else
		{
			$raws = array (
			...
			$raws ['left'][1]		= $raws ['left'][0] == 0 ? null : ($this->raw ['border_bg1'] >> 16) & 0x07;
			$raws ['right'][1]		= $raws ['right'][0] == 0 ? null : ($this->raw ['border_bg1'] >> 23) & 0x07;
			$raws ['top'][1]		= $raws ['top'][0] == 0 ? null : $this->raw ['border_bg2'] & 0x07;
			$raws ['bottom'][1]		= $raws ['bottom'][0] == 0 ? null : ($this->raw ['border_bg2'] >> 7) & 0x07;
			...
			$this->backgroundColor = $this->pattern == 0
				? $this->_workbook->palette [($this->raw ['pattern'] >> 7) & 0x07]
				: $this->_workbook->palette [$this->raw ['pattern'] & 0x07];
		}
